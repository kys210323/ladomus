...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/usr/local --enable-gpl --enable-nonfree --enable-libx264 --disable-debug --disable-doc --disable-asm --extra-cflags=-I/usr/local/include --extra-ldflags=-L/usr/local/lib
prefix=/usr/local
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -L/usr/local/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -llzma -L/usr/local/lib -lx264 -lz
